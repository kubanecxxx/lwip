...
#define GPIOA_ETH_CLK		1
#define GPIOA_ETH_DV		7		//jedna věc peripherals
#define GPIOA_ETH_MDIO		2

#define GPIOB_ETH_TX_EN		11
#define GPIOB_ETH_TXD0		12
#define GPIOB_ETH_TXD1		13

#define GPIOC_ETH_RXD0		4		//audio - je tam odpor nouconnect
...
#define VAL_GPIOB_AFRH      (PIN_AFIO_AF(GPIOB_CAN1_RX, 9) |                \
                             ...
                             PIN_AFIO_AF(GPIOB_ETH_RMII_TX_EN, 11) |        \
                              PIN_AFIO_AF(GPIOB_OTG_HS_VBUS, 11) |        \
                             PIN_AFIO_AF(GPIOB_OTG_HS_ID, 11) |             \
